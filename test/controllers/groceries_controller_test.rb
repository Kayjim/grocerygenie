...
class GroceriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery" do
    assert_difference('Grocery.count') do
      post groceries_url, params: { grocery: { category: @grocery.category, product: @grocery.product, quantity: @grocery.quantity } }
    end
  ...
  test "should update grocery" do
    patch grocery_url(@grocery), params: { grocery: { category: @grocery.category, product: @grocery.product, quantity: @grocery.quantity } }
